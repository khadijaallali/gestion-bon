...
@section('title', 'Résultats de recherche par véhicule')
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <div class="header-text">
                ...
                <p class="page-subtitle">Recherche par véhicule : <strong class="search-term">{{ $vehicule }}</strong></p>
            </div>
        </div>
        <div class="header-actions">
            <a href="{{ route('recherche.vehicule') }}" class="search-btn">
                <i class="fas fa-search"></i> Nouvelle recherche
            </a>
            <a href="{{ route('bons.printV', ['vehicule' => $vehicule]) }}" class="print-btn no-print" target="_blank">
    ...
    <div class="content-section">
        @if ($bons->isEmpty())
            <div class="empty-state">
                ...
                <p class="empty-description">Aucun bon de carburant n'a été trouvé pour le véhicule <strong>{{ $vehicule }}</strong>.</p>
                <a href="{{ route('recherche.vehicule') }}" class="search-btn">
...
.summary-number, .summary-total, .summary-quantity {
    color: #4facfe;
